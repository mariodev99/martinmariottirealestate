  ...
  return (
    <div className="relative flex flex-col items-center">
      <motion.div
        ...
        className="flex items-center cursor-pointer bg-blacksecondary px-6 py-2.5 text-white text-base font-medium rounded-full stroke-white group hover:bg-white hover:text-black hover:stroke-black fill-black duration-75"
      >
        <div>
          {router.locale === "es" && "Esp"}
          {router.locale === "en" && "Eng"}
          {router.locale === "it" && "It"}
        </div>
        <DownArrowIcon />
      </motion.div>
