      ...
      <SectionWraper>
        <div className="grid grid-cols-1 md:grid-cols-3 py-6">
          ...
          <div className="px-0 md:px-10 md:pl-20 pt-6 flex flex-col gap-3">
            ...
            <div className="h-24 relative">
              <Image
                ...
                src={logoApi}
                height={80}
                alt="Logo de El Colegio de Agentes Inmobiliarios "
              />
            </div>
            <div className="h-24 relative">
              <Image
          ...
          <div className=" mt-5 flex flex-col gap-2 md:gap-4 text-lg md:text-xl justify-center items-start md:items-end">
            ...
            <Link className="nav-link" href={"/contacto"}>
              {data.nav.contact_nav}
            </Link>
          </div>
        </div>
        <div className="my-10 h-[2px] bg-gradient-to-r from-[#030E16] via-white to-[#030E16]"></div>
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="order-2 md:order-1 text-light text-sm mt-3 text-[#888]">
            © 2024 Martin Mariotti. All rights reserved
          </p>
          <p className="order-1 md:order-2 text-greenprimary ">
            {" "}
            <a href="mailto:martinmariotti.realestate@gmail.com">
